    ...
    return (
        <svg id="line3" className={props.start ? 'active' : ''}  width="3595" height="500" viewBox="0 0 3595 500" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <defs>
                ...
                <stop stopColor="#423A9C"/>
                <stop offset="0.09375" stopColor="#5746A5"/>
                <stop offset="0.375" stopColor="#7E43A6"/>
                <stop offset="0.697917" stopColor="#FF7F83"/>
                </radialGradient>
            </defs>
        </svg>
    )
